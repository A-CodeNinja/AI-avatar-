...
Page({
  data: {
    ...
    menuList: [
      ...
      { icon: '/images/icons/contact.png', title: '用户反馈', url: '/pages/feedback/feedback', desc: '', color: 'linear-gradient(135deg, #2196F3 0%, #03A9F4 100%)' },
  ...
  onTapAvatar() {
    ...
    wx.navigateTo({
      url: '/pages/auth/auth?redirect=/pages/mine/mine'
    });
  },
